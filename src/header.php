    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <!-- if current page is about-us or child page's parent is about-us add this class -->
            <li <?php if (is_page('about-us') or wp_get_post_parent_id(0) == 6) echo 'class="current-menu-item"'; ?>>
        ...
        <div class="site-header__util">
          <?php if (is_user_logged_in()): ?>
            <a href="<?php echo esc_url(site_url('my-notes')); ?>" class="btn btn--small btn--orange float-left push-righ">My Notes</a>
